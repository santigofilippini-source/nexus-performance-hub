...
async function doForgotPassword(){
  ...
  err.style.color='var(--text-2)';err.textContent='Enviando...';
  try{
...
function updateSidebarNav(){
  ...
  h+=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg><span class="label" style="margin-left:6px;">Programas</span><span class="n">${progCount||''}</span></div>`;
  h+=`<div class="q-tree__cat${exActive?' active':''}" onclick="openMyExercises()" style="border-radius:8px;">`;
  h+=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6.5 6.5 17.5 17.5M6.5 17.5 17.5 6.5M3 12h2m14 0h2M7 8v8m10-8v8"/></svg><span class="label" style="margin-left:6px;">Mis ejercicios</span><span class="n">${exCount||''}</span></div>`;
  ...
  h+=`<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg><span class="label" style="margin-left:6px;">Ejercicios Qoore</span><span class="n">${qooreExCount||''}</span></div>`;
