...
const DEFAULT_EXERCISES = {
  ...
  // ── Tren superior ─────────────────────────────────────────────
  'def_bp':      {name:'Press de banca plano',            category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=k6pjyttymvw'},
  'def_ohp':     {name:'Press militar con barra',         category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=sMKbfjc5Z2s'},
  ...
  'def_pull':    {name:'Dominadas / Pull-up',             category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=uXEY7ZCqEjo'},
  'def_dips':    {name:'Fondos en paralelas',             category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=vkj18HFQxj0'},
  'def_curl':    {name:'Curl de bíceps con mancuerna',    category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=OBaE0qZMUpE'},
  'def_tri':     {name:'Extensión de tríceps en polea',   category:'Tren superior'},
  // ── Core ──────────────────────────────────────────────────────
  'def_plank':   {name:'Plancha isométrica',              category:'Core',                   videoUrl:'https://www.youtube.com/watch?v=RUow4-t5W_A'},
  ...
  'def_bblunge':   {name:'Estocada con barra (Barbell Lunge)',        category:'Tren inferior',          videoUrl:'https://www.youtube.com/watch?v=bWA9wmMLSIM'},
  'def_tricext':   {name:'Copa de tríceps (Tricep Extension)',        category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=LI9rf5RGY_U'},
  'def_latraise':  {name:'Elevaciones laterales (Lateral Raises)',    category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=OWAcFvpA7jA'},
  'def_abwheel':   {name:'Rueda abdominal (Ab Wheel)',                category:'Core',                   videoUrl:'https://www.youtube.com/watch?v=Wj8k-7zGs0I'},
  'def_mountclimb':{name:'Escaladores (Mountain Climbers)',           category:'Core',                   videoUrl:'https://www.youtube.com/watch?v=_ghfYqn94Vo'},
  'def_jumprope':  {name:'Salto a la comba (Jump Rope)',              category:'Cardio / Metabólico',    videoUrl:'https://www.youtube.com/watch?v=uWz-QvZW3oM'},
  'def_hipmob':    {name:'Movilidad de cadera (Hip Mobility)',        category:'Movilidad / Elongación', videoUrl:'https://www.youtube.com/watch?v=9j_uF9Jl5pA'},
  'def_shouldermob':{name:'Movilidad de hombro (Shoulder Mobility)',  category:'Movilidad / Elongación', videoUrl:'https://www.youtube.com/watch?v=1vS94MJK4ps'},
  ...
  'def_dblunge':   {name:'Estocada con mancuerna (DB Lunge)',                    category:'Tren inferior',          videoUrl:'https://www.youtube.com/watch?v=fk_aTgTYaZk'},
  ...
  'def_dbbp':      {name:'Press de banca con mancuernas (DB Bench Press)',        category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=ky7cLOtyiqM'},
  'def_dbohp':     {name:'Press militar con mancuernas (DB Military Press)',      category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=tAfEwbUWmOc'},
  'def_dbrow':     {name:'Remo con mancuerna (DB Row)',                           category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=TnrZQPxLxSo'},
  'def_neutralpull':{name:'Dominadas agarre neutro (Neutral Grip Pull-Up)',       category:'Tren superior',          videoUrl:'https://www.youtube.com/watch?v=aq_P7EN0RlA'},
